...
# Configurar el pin 25 como salida
pin25 = Pin(25, Pin.OUT)

# Poner el pin 25 en LOW (GND)
pin25.value(0)
...
def main():
    ...
    OTA = senko.Senko(user="soportewavesoluciones", repo="wave", working_dir="BellaVista", files=["main.py", "boot.py", "config.json"])
